...
/**
 * @file
 * Contains \Drupal\restful_toboggan\Plugin\resource\LoginCookieToboggan__1_0.
 */

namespace Drupal\restful_toboggan\Plugin\resource;
...
/**
 * Class LoginCookieToboggan__1_0
 * @package Drupal\restful_toboggan\Plugin\resource
 *
 * @Resource(
 *   name = "login_cookie_toboggan:1.0",
 *   resource = "login_cookie_toboggan",
 *   label = "Login",
 *   description = "Login a user and return a JSON along with the authentication cookie and username or password",
 *   authenticationTypes = {
 *     "basic_auth_toboggan"
 *   },
 *   dataProvider = {
 ...
 *     },
 *   },
 *   menuItem = "login-toboggan",
 *   majorVersion = 1,
 *   minorVersion = 0
 * )
 */
class LoginCookieToboggan__1_0 extends ResourceEntity implements ResourceInterface
{
